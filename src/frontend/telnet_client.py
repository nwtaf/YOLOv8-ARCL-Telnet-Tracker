...
host = "192.168.." # Replace with the correct IP address
port = 7171
...
def load_logger():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(log_file, mode='w')  # Add FileHandler for logging output to file with mode='w' (write not append)
        ]
    )
    logger = logging.getLogger(__name__)

    logger.debug(f'Logger setup using log_file path: {log_file}')
